function [data,back,ref]=sif_read(file)
%SIFREAD - Read Andor SIF multi-channel image file.
%
%Synopsis:
%
...
skipLines(f,8);
if ( strcmp('Luc',info.detectorType) || ... 
     strncmp('DV8',info.detectorType,3) || strncmp('DU8',info.detectorType,3))
  skipLines(f,2);                       % Andor Luca or ixon
end
