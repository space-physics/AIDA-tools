...
startvec = tmpopt(1:8);
if exist('fminunc')==2
  optpar0 = fminunc(@(startvec) automat4(startvec,identstars,mode,tmpopt(1:8),lockpar),startvec);
else
  optpar0 = fminsearch(@(startvec) automat4(startvec,identstars,mode,tmpopt(1:8),lockpar),startvec);
end
