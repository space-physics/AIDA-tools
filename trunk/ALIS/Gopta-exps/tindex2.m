...
OPS1.object =  'Index: filter cycle tindex2_fast.eps';
OK = to_gopta('tindex2_fast',sn,Startstop,c_l1,filter1 ,POS,exptimes-300,interv,GTfast,OPS1);
OPS1.object =  'Index: filter cycle tindex2_3_06.eps';
OK = to_gopta('tindex2_3_06mn',sn,Startstop,c_l1,filter1   ,POS,exptimes-400,interv,GTlittlenoise,OPS1);

interv(:) = 4;
exptimes(:) = 2000;

OPS1.object =  'Index: filter cycle tindex2_4_13.eps';
OK = to_gopta('tindex2_4_13ln',sn,Startstop,c_l1,filter1   ,POS,exptimes-700,interv,GTlownoise,OPS1);
OPS1.object =  'Index: filter cycle tindex2_4_16.eps';
OK = to_gopta('tindex2_4_16mn',sn,Startstop,c_l1,filter1   ,POS,exptimes-400,interv,GTlittlenoise,OPS1);
