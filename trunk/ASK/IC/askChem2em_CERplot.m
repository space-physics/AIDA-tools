function [ph,CER,emissions] = askChem2em_CERplot(emissions,OPS,varargin)
% ASKCHEM2EM_CERPLOT - plot column emission rates from SOTON Chemistry model emission-file/struct
%   
% Calling:
