function [ph,Ems,emissions] = askChem2em_TAVplot(emissions,OPS,varargin)
...
title(emissions.reactions_vec{2}(emissions.profile_vars(dOPS.indxLambda2plot-1)),'fontsize',15,'interpreter','tex')
