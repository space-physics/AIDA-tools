function [Vem,stns] = tomo_start_guessN(stns,alt,width,X3D,Y3D,Z3D,infunction,OPS)
...
% 
% Calling:
% [Vem,stns] = tomo_start_guessN(stns,alt,width,X3D,Y3D,Z3D,infunction,OPS)
%
...
disp('You''re calling tomo_start_guessN from:')
dbstack
